...
// Recruiting — moved from the standalone /recruiting top-level tab into
// HR as a sub-tab (2026-08-02), same session Takt took over Recruiting's
// old nav slot. Content unchanged from src/pages/Recruiting.jsx — no
// longer wrapped in page-content/page-header (Hr.jsx supplies those) and
// no longer behind its own RecruitingPasswordGate (inherits HR's gate
// instead). src/pages/Recruiting.jsx and RecruitingPasswordGate.jsx are
// now orphaned — left in place (no file-delete tool), need a manual
// git rm.
