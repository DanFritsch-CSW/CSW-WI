...
// 30/60/90 Check-Ins — HR sub-tab (added 2026-08-07), same pattern as
// RecruitingTab.jsx: no page-content/page-header wrapper, Hr.jsx supplies
// those, inherits HrPasswordGate instead of its own gate.
//
// Distinct from the Employee Onboarding module's trainer curriculum
// (day30/60/90_review_conducted in Supabase) — this tracks HR's follow-up
// calls (Maria/Amy) + benefits enrollment, not trainer sign-off.
...
export default function ThirtySixtyNinetyTab() {
